...
import (
	"github.com/soluchok/gokogiri/html"
	"github.com/soluchok/gokogiri/xml"
)
...
found in the github.com/soluchok/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
